...
public class Panel7 extends JFrame {
    ...
    public Panel7(int idAeropuerto) {
        ...
        panel7.setBounds(40, 18, 300, 300);
        ...
        list1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new Panel13(idCompania).setVisible(true);
                dispose();
    ...
    public void leerDato() {
        String query = "SELECT idCompania, nombre FROM companias ORDER BY idCompania LIMIT 2 OFFSET 4 ";
        try {
