...
public class Panel10 extends JFrame {
    ...
    public Panel10(int idCompania) {
        ...
        panel10.setBounds(40, 18, 300, 300);
    ...
    public void leerDato() {
        String query = "SELECT idVuelo, ciudadOrigen, ciudadDestino, precio FROM vuelos ORDER BY idVuelo LIMIT 2 OFFSET 0";
        try {
