...
public class Panel13 extends JFrame {
    ...
    public Panel13(int idCompania) {
        ...
        panel13.setBounds(40, 18, 300, 300);
    ...
    public void leerDato() {
        String query = "SELECT idVuelo, ciudadOrigen, ciudadDestino, precio FROM vuelos ORDER BY idVuelo LIMIT 2 OFFSET 4";
        try {
