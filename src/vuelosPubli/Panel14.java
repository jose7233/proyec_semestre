...
public class Panel14 extends JFrame {
    ...
    public Panel14(int idCompania) {
        ...
        panel14.setBounds(40, 18, 300, 300);
    ...
    public void leerDato() {
        String query = "SELECT idVuelo, ciudadOrigen, ciudadDestino, precio FROM vuelos ORDER BY idVuelo LIMIT 2 OFFSET 6";
        try {
