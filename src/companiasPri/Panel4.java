...
public class Panel4 extends JFrame {
    ...
    public Panel4(int idAeropuerto) {
        ...
        panel4.setBounds(40, 18, 300, 300);
        ...
        list1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new Panel10(idCompania).setVisible(true);
                dispose();
    ...
    public void leerDato() {
        String query = "SELECT idCompania, nombre FROM companias ORDER BY idCompania LIMIT 2 OFFSET 0";
        try {
